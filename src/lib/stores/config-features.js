export const config = {
	mapTitle: 'employment-rate', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-employment-rate.vercel.app/', // The url provided when deploying the map on Vercel
